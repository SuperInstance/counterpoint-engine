...
print("For N voices, minimally rigid = exactly 2N-3 edges.")
print("This ensures every voice is independently constrained,")
print("with no redundant constraints and no unconstrained degrees of freedom.")
